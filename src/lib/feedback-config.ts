...
export const FEEDBACK_ENDPOINT = ""; // e.g. "https://script.google.com/macros/s/AKfycb.../exec"
export const ADMIN_KEY = "CHANGE_ME_TO_A_LONG_RANDOM_STRING"; // must match SECRET in Apps Script
